...
<div class="alert alert-warning col-lg-7 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-0 col-sm-offset-1 col-xs-offset-0" style="margin-top:70px">
	<div style="display: inline;">
		...
		<strong>Upload Student list (CSV that only)</strong>
		<frameset style="border: 3px;">
			<form action="importStudents.php" method="post" enctype="multipart/form-data">
				<input type="file" class="form-control" name="file" required />
				<br>
				<input type="submit" name="submitList" class="form-control btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" Value="Upload Students List"></p><br><br>
				<a href="addstudent.php"><span class="form-control col-lg-3 col-md-4 col-sm-11 col-xs-11  glyphicon glyphicon-plus-sign" style="margin-left: 15px;margin-bottom: 5px" span><span class=""></span> Add a student</button></a>
			</form>
		</frameset>
	</div>
</div>
